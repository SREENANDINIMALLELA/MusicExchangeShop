...
1. Create a IPlay interface that could be applied to shop-items. This should have a play method that returns the sound of the instrument being played as a String.
